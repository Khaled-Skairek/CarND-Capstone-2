...
STOP_LINE_MARGIN = 3  # Mergin in waypoints to pad in front of the stop line
MAX_DECEL = 0.5
...
class WaypointUpdater(object):
    ...
    def get_closest_waypoint_idx(self):
        if self.waypoint_tree is None:
            rospy.logerr("waypoint_tree is None")
        ...
        # equation for hyperplane through the closest coords
